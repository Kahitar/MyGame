...
class UIElement
{
    public:
        ...
        void addTextBox(std::string name, std::string text, std::string FontPath = "assets\\fonts\\PAPYRUS.TTF",
                        sf::Vector2f position = sf::Vector2f(0,0), int borderThickness = 1,
